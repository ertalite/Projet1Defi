...
function check_raylib()
    if(os.isdir("raylib") == false and os.isdir("raylib-master") == false) then
        if(not os.isfile("raylib-master.zip")) then
            ...
            local result_str, response_code = http.download("https://github.com/raysan5/raylib/archive/refs/tags/4.5.0.zip", "raylib-master.zip", {
        ...
        os.rename("raylib-4.5.0", "raylib-master")
    end
end
